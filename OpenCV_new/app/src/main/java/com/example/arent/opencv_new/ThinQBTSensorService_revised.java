...
public class ThinQBTSensorService_revised extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.e("onCharacteristicRead","gatt status" +status );
            }
        }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if(status == BluetoothGatt.GATT_SUCCESS){
                ...
                Log.e("onCharacteristiWrite()", "status"+status);
            }
        }
    ...
    public void writeVibCharacteristic(byte[] value){
        if (mBluetoothGatt == null) {
            ...
            if (mService != null && value != null) {
                ...
                Log.i(TAG, "writeVibCharacteristic - result: " + result + " write: " + Arrays.toString(value));
            } else {
    ...
    private void broadcastUpdate(final String action,
        ...
        if (BleAttributes.BATTERY_LEVEL_CHARACTERISTIC_UUID.equals(characteristic.getUuid())) {
            ...
            Log.e("broadcastUpdate", action + "-"+characteristic.getUuid());
    ...
    public class LocalBinder extends Binder {
        public ThinQBTSensorService_revised getService() {
            return ThinQBTSensorService_revised.this;
        }
    }
